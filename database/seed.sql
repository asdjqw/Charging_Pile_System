...
INSERT OR IGNORE INTO users (id, username, password, phone, balance, car_model, plate_number) VALUES
(1, 'zhangsan', '123456', '13800001111', 200.00, '比亚迪汉EV', '京A·D1234'),
(2, 'lisi', '123456', '13900002222', 80.50, '特斯拉Model 3', '京B·T8888'),
(3, 'wangwu', '123456', '13700003333', 500.00, '小鹏P7', '京C·X6666');
...
INSERT OR IGNORE INTO charging_orders (id, order_no, user_id, pile_id, start_time, end_time, energy_kwh, amount, status) VALUES
(1, 'ORD20260828001', 1, 3, '2026-08-28 09:10:00', '2026-08-28 09:45:00', 28.5, 51.30, 'finished'),
(2, 'ORD20260829001', 2, 9, '2026-08-29 14:00:00', '2026-08-29 14:35:00', 42.0, 88.20, 'finished'),
(3, 'ORD20260830001', 1, 7, '2026-08-30 18:20:00', '2026-08-30 19:05:00', 35.2, 61.60, 'finished'),
(4, 'ORD20260831001', 3, 3, '2026-08-31 10:00:00', NULL, 12.0, 21.60, 'ongoing'),
(5, 'ORD20260831002', 2, 9, '2026-08-31 11:30:00', NULL, 8.5, 17.85, 'ongoing');
